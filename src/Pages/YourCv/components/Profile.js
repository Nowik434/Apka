...
function Profile() {
  ...
  const ProfileSchema = yup.object().shape({
    ...
    location: yup
      ...
      .min(3, "Miasto jest za krótkie"),
    position: yup.string().required("Stanowisko jest wymagane").min(3, "Stanowisko jest za krótkie"),
    email: yup.string().required("Email jest wymagany").min(3, "Email jest za krótki").email("Wpisz prawidłowy adres Email"),
    phone: yup
      .string()
    ...
    facebook: yup 
      .string()
      .url("Wpisz prawidłowy adres url"),
    linkedin: yup 
      .string()
      .url("Wpisz prawidłowy adres url"),
    website: yup 
